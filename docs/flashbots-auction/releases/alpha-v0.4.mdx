...
Miners must configure a new command line paramter to specify which relays megabundles will be accepted. The parameter is set as follows for a list of 3 relayers.

```bash
-miner.megabundlebundlerelays=0xADDR1,0xADDR2,0xADDR3
```
...
```bash
-miner.megabundlebundlerelays=0x870e2734DdBe2Fba9864f33f3420d59Bc641f2be,0xADDR2,0xADDR3
```
