...
* miner.trustedrelays (string) - comma separated, hex encoded addresses of trusted relays that the miner will be able to accept megabundles from, being reasonably certain about DDoS safety
...
A pre-merged set of `bundles` coming from a `relay`.
