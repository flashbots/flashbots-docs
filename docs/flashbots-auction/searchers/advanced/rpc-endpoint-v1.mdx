...
use v2 methods for get user stats and bundle stats, v1 methods will be deprecated soon!
...
User stats and Bundle stats v1 will be deprecated soon. Make sure to use V2 methods

---

### flashbots_getUserStats (V1 will be deprecated soon, use V2)
...
### flashbots_getBundleStats (V1 will be deprecated soon, use V2)
...
All method supports JSON-RPC standards for success response and REST HTTP standards for error response.
