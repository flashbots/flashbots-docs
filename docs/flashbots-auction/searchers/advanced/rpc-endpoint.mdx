...
By default, transactions are sent to the Flashbots Matchmaker with the default [Stable](/flashbots-protect/rpc/mev-share#stable-configuration) configuration. The `auction` parameter allows you to specify your own privacy parameters.
