...
```json
{
  ...
  "params": [{
    ...
    preferences: { fast: boolean } // for backwards compatibility; may be removed in a future version
  }]
}
```
  ...
  "params": [
    {
      ...
      "preferences": { "fast": true } // for backwards compatibility; may be removed in a future version
    }
  ]
}
```
