...
The `eth_cancelPrivateTransaction` method stops private transactions from being submitted for future blocks. This method has the following JSON-RPC format:
