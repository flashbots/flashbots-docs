...
1. A reverting transaction (unless specified via [optional argument `revertingTxHashes`](/flashbots-auction/searchers/advanced/rpc-endpoint-v1#eth_sendbundle) or uncled)
