...
| Fast Execution | `https://rpc.flashbots.net?auction=enabled&hint=logs&hint=function_selector&hint=contract_address&hint=transaction_hash` |
| Max Speed & MEV Kickbacks (Low Privacy) | `https://rpc.flashbots.net?auction=enabled&hint=calldata&hint=logs&hint=function_selector&hint=contract_address&hint=transaction_hash` |
