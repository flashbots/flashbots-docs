...
- Additionally, `eth_sendPrivateTransaction` is freely supported on [Alchemy](https://alchemy.com?a=fb) and [QuickNode Marketplace](https://marketplace.quicknode.com/add-on/flashbots-protect?utm_source=flashbots_docs).
