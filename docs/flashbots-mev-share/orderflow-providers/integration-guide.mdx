...
Connecting to RPC with this configuration would share logs and function selectors, and send transactions to all supported builders:

```txt
https://rpc.flashbots.net?mevshare=enabled&hint=logs&hint=function_selector&targetBuilder=all
```
