...
To send transactions directly to Flashbots MEV-Share Node, use a [client library](https://github.com/flashbots/mev-share-client-ts) or send a request to the [`sendPrivateTransaction`](/flashbots-auction/searchers/advanced/rpc-endpoint#eth_sendprivatetransaction) endpoint with the `privacy` parameter.
