...
Bundle composition is enabled by the `privacy` parameter in `mev_sendBundle`. See [Sending Bundles](/flashbots-mev-share/searchers/sending-bundles#share-bundle-data) for more information.
