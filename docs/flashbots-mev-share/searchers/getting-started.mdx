...
The simplest way to connect to the Flashbots MEV-Share Node is to use a [client library](/flashbots-auction/searchers/libraries/matchmaker). For this guide, we'll refer to [mev-share-node-ts](https://github.com/flashbots/matchmaker-ts).
...
See the documentation in the [mev-share-node-ts](https://github.com/flashbots/matchmaker-ts) repo to learn more.
