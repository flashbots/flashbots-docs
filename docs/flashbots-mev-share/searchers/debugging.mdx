...
type SimBundleLogs = {
  ...
  logs?: Array<{
		...
		txLogs?: Array<[LogParams](https://docs.ethers.org/v6/api/providers/formatting/#LogParams)>,
...
This means that your bundle *could have* landed in a block, but it isn't a guarantee. If your `mevGasPrice` is not high enough, your bundle may not be included in a block. Refer back to [Did it pay enough gas?](https://www.notion.so/Did-it-pay-enough-gas-21390bd54e9b42478f137250c97aaf7a?pvs=21) for info on setting your gas price.
